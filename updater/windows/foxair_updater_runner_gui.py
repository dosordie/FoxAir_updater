...
class MainWindow(legacy.MainWindow):
    ...
    def _phase_text(phase: str) -> str:
        return {
            ...
            "service-restart-wait": "Warte auf Neustart des LTE-Kommunikationsdienstes",
            "service-restart-verified": "LTE-Kommunikationsdienst wurde erfolgreich neu gestartet",
            "service-ready-wait": "Warte, bis der LTE-Kommunikationsdienst vollständig bereit ist",
            "service-ready": "LTE-Kommunikationsdienst ist vollständig bereit",
            ...
            "failure-report": "Mainboard meldet einen Fehler – Abschluss wird geprüft",
            "success": "Firmwareupdate erfolgreich abgeschlossen",
            "same-version": "Gleiche Firmware erkannt – keine Übertragung erforderlich",
            "same-version-restore": "Originalzustand nach der Versionsprüfung wird wiederhergestellt",
            "failed": "Firmwareupdate wurde mit einem Fehler beendet",
            "precondition-rejected": "Voraussetzungen für das Firmwareupdate wurden nicht erfüllt",
            "parser-rejected": "Firmwareupdate konnte nicht an den LTE-Dienst übergeben werden",
            "c36e-rejected": "Mainboard hat die Update-Anfrage abgelehnt",
            "debugger-ended-before-terminal": "Update-Überwachung wurde unerwartet beendet",
            "debugger-unexpected-stop": "Update-Überwachung wurde unerwartet unterbrochen",
            "runner-lost": "Autonomer Update-Runner auf dem LTE-Modem ist nicht mehr aktiv",
            "recovery-required": "Automatische Wiederaufnahme nicht möglich – manuelle Prüfung erforderlich",
            "backup": "Sicherung der LTE-Updateinformationen ist fehlgeschlagen",
            ...
            "hook-ended-before-authority": "Update-Überwachung wurde vor Beginn der Übertragung beendet",
            "original-service-active-unmonitored": "Firmwareupdate läuft weiter – lokale Überwachung ist beendet",
